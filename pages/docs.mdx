...
- [Using Articles](#using-articles)
- [Using Custom Pages](#using-custom-pages)
- [Generate Social Images](#generate-social-images)
- [Incremental Build](#incremental-build)
- [Social Networks & Email Address](#social-networks-email-address)
- [Edit on GitHub](#edit-on-github)
- [Support on Patreon](#support-on-patreon)
- [Styles in MDX](#styles-in-mdx)
...
Additionally you could define `language` key to set the default language of the website, by default is `en`. This is used for [Internationalization feature](#internationalization)
...
<div id="social-networks-email-address" />
